...
- v0.1.7 构建、推送、标签和 GitHub Release 已完成；当前未完成项仍包括真实网络 Plugin 的完整安装回滚、试启动冲突检查、Session deep link、MCP Manager 状态桥接和 Theme/Wallpaper 资源。`.dshpack` 的最小导入格式已实现，尚未实现市场资源导出或更复杂的整合包内容。
