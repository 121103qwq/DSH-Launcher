...
| 最小化 / 最大化 / 关闭 | — □ × | U+2014 / U+25A1 / U+00D7 | 标题栏三按钮（**按墨迹等大**：2026-09-13 先由 22/18/28 收敛为 18 → 140 整体加大到 22 → **141 按截图实测墨迹把 × 补到 26**，使三字形视觉等大） | **22 / 22 / 26** |
...
- **尺寸**：**导航 / 按钮字形 18px**；**标题栏三字形按墨迹等大：— 22px / □ 22px / × 26px**（变更集 141 实测口径：22px 时墨迹为 — 28×2、□ 13×13、× 11×11，同字号下 `×` 的墨迹比 `□` 小约 15%，故单独放大）；空态装饰字形 30px（品牌例外）；列表内字形继承宿主字号。
