...
当前为 Launcher Core 0.1.1，完成了独立 WPF 主窗口、PCL2 风格的信息架构骨架和 Node.js 环境检测。Node 检测在后台异步执行，单个候选总超时后会清理残留进程；Launcher 自身不依赖 Node.js、npm、pnpm 或已经安装的 DeepSeek Harness。
