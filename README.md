...
| 119 | `VersionSettingsWindow.xaml` + `MainWindow.xaml(.cs)` + `ExtensionWindow.xaml` + `VersionControlWindow.xaml` | **两栏页面统一：左栏 320 + 18 间隙、内容上限 1200 居中（work-log/102）**：实例设置左栏 180→320、设置/诊断 host 左栏 196→320 且面板 MaxWidth 980→1200、扩展 340/16→320/18、版本控制 280/20→320/18，启动页与上述页均加 `MaxWidth=1200` 居中；对话页保持比例式 2*:*（另议）；SelfTest 156 / harness 348 / UIA 量宽 5 PASS（实例设置 666px、设置/诊断 643px）；发布 MD5 `b993ce6b…` |
